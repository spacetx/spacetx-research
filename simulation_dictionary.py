...
class SimulationDictionary(dict):
    ...
    def __init__(self):
        ...
        self['PRIOR.width_zmask'] = 0.01 # the width of the prior is inversely proportional to its strength
        self['PRIOR.width_zwhat'] = 0.01 # the width of the prior is inversely proportional to its strength
