...
exp: neptune.experiments.Experiment = \
    neptune.create_experiment(params=flatten_dict(params),
                              upload_source_files=["./main_mnist_rebuttal.py",
                                                   "./MODULES/vae_model.py",
                                                   "./ML_parameters.json"],
                              upload_stdout=True,
                              upload_stderr=True)
...
test_loader = SpecialDataSet(img=img_test,
                             ...
                             drop_last=False,
                             shuffle=False)
test_out_loader = SpecialDataSet(img=img_test_out,
                                 roi_mask=None,
                                 seg_mask=seg_mask_test_out,
