...
from .unet_model import UNet, PreProcessor
from .encoders_decoders import EncoderInstance, DecoderInstance, DecoderBackground, DecoderWhere
from .utilities import tmaps_to_bb, convert_to_box_list, invert_convert_to_box_list
from .utilities import compute_ranking, compute_average_in_box
from .utilities_ml import sample_and_kl_diagonal_normal, sample_c_map
from .utilities_ml import compute_kl_DPP, compute_kl_Bernoulli, SimilarityKernel
from .namedtuple import Inference, NMSoutput, BB, UNEToutput, ZZ, DIST
...
class Inference_and_Generation(torch.nn.Module):
    ...
    def forward(self, imgs_bcwh: torch.Tensor,
        ...
        # 1. UNET
        # ---------------------------#
        imgs_preprocessed_bcwh: torch.Tensor = self.preprocesser.forward(imgs_bcwh, verbose=False)
